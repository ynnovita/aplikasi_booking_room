...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Payment Method</h3>
	</div>
	<div class="card-body">
		<form action="" id="accommodation-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="accommodation" class="control-label">Methode</label>
            ...
            <div class="form-group">
				<label for="price" class="control-label">Detail</label>
