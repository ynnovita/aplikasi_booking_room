                ...
                ?>
                    <tr>
                        ...
                        <td align="center">
                                ...
                                <a class="dropdown-item views_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-file text-primary"></span> View</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item cancel_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-times text-danger"></span> Cancel</a>
                                </div>
                        </td>
                    </tr>
                <?php endwhile; ?>
...
<script>
    ...
    $(function(){
        ...
        $('.views_data').click(function(){
            uni_modal("Booking Information","views.php?id="+$(this).attr('data-id'))
        })
        $('table').dataTable();
    })
</script>