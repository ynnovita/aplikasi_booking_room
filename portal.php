...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading">Welcome To <?php echo $_settings->info('short_name') ?></div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">View Rooms</a>
	</div>
</header>
<!-- Services-->
<section class="page-section bg-dark" id="home">
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=rooms" class="btn btn-flat btn-warning mr-4">Explore More Rooms <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
<!-- About-->
